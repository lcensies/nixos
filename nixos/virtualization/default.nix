{ config, pkgs, ... }:
{
  ...
  # DISABLED: Virbr0 fix workarounds - can interfere with VPN DNS/network setup.
  # Re-enable if VM networking breaks after VPN connects (see stories/VM-VPN-FIX-SUMMARY.md).
